...
bus.write_byte_data(adress_20,IO_DIR_A,0x05)
...
L3_read = [0,83,83,83,87,72,71,86]
L3_write = [0,17,18,19,20,21,22,23]
L3_in = [0,0,0,0,8,16,32,64]
L3_result = [0,0,0,0,0,0,0,0]

R1_read = [0,83,83,83,75,74,73,86]
R1_write = [0,25,26,27,28,29,30,31]
R1_in = [0,0,0,0,8,16,32,64]
R1_result = [0,0,0,0,0,0,0,0]

R2_read = [0,83,83,83,78,77,76,86]
R2_write = [0,33,34,35,36,37,38,39]
R2_in = [0,0,0,0,8,16,32,64]
R2_result = [0,0,0,0,0,0,0,0]

R3_read = [0,83,83,83,88,80,79,86]
R3_write = [0,41,42,43,44,45,46,47]
